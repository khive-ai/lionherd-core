...
```python
from lionherd_core.base import Graph, Node, Edge
...
4. **Consistency**: Unified interface with other lionherd primitives
...
See `src/lionherd_core/base/graph.py` for full implementation details.
