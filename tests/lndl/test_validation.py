...
"""Comprehensive LNDL validation tests.

This module consolidates tests for:
1. Validation Guards - Prevents persisting unexecuted ActionCall placeholders
2. Revalidation Lifecycle - Action result substitution and field validation

The core footgun: Users forget to call revalidate_with_action_results() after parsing,
leading to ActionCall objects being persisted/used instead of real values. The validation
guard (ensure_no_action_calls) prevents this by raising clear errors.

Organization:
- Section 1: Validation Guards (ensure_no_action_calls, has_action_calls)
- Section 2: Revalidation Lifecycle (revalidate_with_action_results)
"""
...
# ============================================================================
# Model Definitions (for revalidation tests)
# ============================================================================
...
# ============================================================================
# SECTION 1: VALIDATION GUARDS
# ============================================================================
# Tests for has_action_calls() and ensure_no_action_calls() guards.
# These prevent the footgun of persisting unexecuted ActionCall objects.
# ============================================================================
...
# ============================================================================
# SECTION 2: REVALIDATION LIFECYCLE
# ============================================================================
# Tests for revalidate_with_action_results() and action lifecycle.
# These verify action result substitution and Pydantic validation.
# ============================================================================
...
class TestHasActionCalls:
    ...
    def test_returns_true_with_single_action_call(self):
    ...
    def test_returns_true_with_multiple_action_calls(self):
    ...
    def test_returns_false_with_no_action_calls(self):
    ...
    def test_returns_true_with_mixed_fields(self):
...
class TestRevalidateWithActionResults:
    ...
    def test_success_single_action(self):
    ...
    def test_success_multiple_actions(self):
    ...
    def test_error_missing_action_result(self):
    ...
    def test_error_missing_multiple_action_results(self):
    ...
    def test_enforces_pydantic_field_constraints(self):
        """Re-validation enforces Pydantic field constraints."""
        report = StrictReport.model_construct(
            title="Report",
            summary=ActionCall("summarize", "generate", {}, "generate()"),
        )
    ...
    def test_enforces_field_validators(self):
        """Re-validation runs custom field validators."""
        report = ValidatedReport.model_construct(
            title="Report",
            summary=ActionCall("summarize", "generate", {}, "generate()"),
        )
    ...
    def test_preserves_type_after_revalidation(self):
        ...
        assert type(validated) is Report
        assert isinstance(validated, Report)
